...
public class BasePage extends Page {
	...
	public void waitForElementToBePresent(WebElement element) {
		...
		{
			logger.error(element+" element could Not Be found on DOM Within given wait time  "+e);
			throw e;
		}
	}
	...
	public void waitForFrame(WebElement element) {
		...
		{
			logger.error(element+" Frame is not available  "+ e);
			e.printStackTrace();
			throw e;
		}
	}
	...
	public void waitForElementToBeClickable(WebElement element) {
		...
		{
			logger.error(element+" Element Is not clickable  "+e);
			throw e;
		}
	}
	...
	public void waitForElementsToBePresent(List<WebElement> elements) {
		...
		{
			logger.error(" element could Not Be found on DOM Within given wait time  "+e);
			throw e;
		}
	}
	...
	public void waitForElementsToBePresentByLocator(By locator,int number)
	{
		...
		{
			logger.error(locator+" element could Not Be found on DOM Within given wait time  "+e);
			throw e;
		}
	}
